...
export default function Footer() {
  return (
    <footer className="bg-bg text-hero-sub py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div className="space-y-4">
            {/* логотип берётся из public/ */}
          ...
          {/* Contact */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-hero-sub">Get in Touch</h4>
            <div className="space-y-3">
              <div className="flex items-center space-x-2 text-hero-sub hover:text-accent transition-colors duration-200">
                <Mail className="h-4 w-4" />
                <a href="mailto:ruzanmart1@gmail.com" className="hover:underline">
                  ruzanmart1@gmail.com
                </a>
              </div>
              <p className="text-hero-sub text-sm">Sacramento, CA</p>
            </div>
          </div>

          {/* Social */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-hero-sub">Follow Me</h4>
            <div className="flex space-x-4">
              <a
                href="https://www.behance.net/ruzanmarti76b1"
                target="_blank"
                rel="noopener noreferrer"
                className="text-hero-sub hover:text-accent transition-colors duration-200 focus:outline-none"
                aria-label="Behance"
              >
        ...
        <div className="mt-8 pt-8 border-t border-gray-600">
          <p className="text-center text-hero-sub text-sm">
