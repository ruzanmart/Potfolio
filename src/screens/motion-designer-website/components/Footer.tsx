      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            {/* логотип из public/ */}
            <img src="/stroke.svg" alt="RM Logo" className="h-8 w-auto" />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a
                href="mailto:ruzanmart1@gmail.com"
                className="flex items-center gap-2 transition-colors duration-200 hover:text-[var(--accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 rounded"
              >
                <Mail className="h-4 w-4" />
                <span>ruzanmart1@gmail.com</span>
              </a>
              <p className="text-sm">Sacramento, CA</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              {/* Behance (inline SVG, наследует currentColor) */}
              <a
                href="https://www.behance.net/ruzanmarti76b1"
                target="_blank"
                rel="noopener noreferrer"
                className="transition-colors duration-200 hover:text-[var(--accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 rounded"
                aria-label="Behance"
                title="Behance"
              >
                <svg
              ...
              <a
                href="https://www.linkedin.com/in/ruzanmart/"
                target="_blank"
                rel="noopener noreferrer"
                className="transition-colors duration-200 hover:text-[var(--accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 rounded"
                aria-label="LinkedIn"
              ...
              <a
                href="https://www.instagram.com/ruzanmart1/"
                target="_blank"
                rel="noopener noreferrer"
                className="transition-colors duration-200 hover:text-[var(--accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 rounded"
        ...
        {/* Copyright */}
        <div className="mt-8 pt-8 border-t" style={{ borderColor: 'var(--stroke)' }}>
          <p className="text-center text-sm">
            © {new Date().getFullYear()} <span style={{ color: '#DED3A6' }}>RM</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
