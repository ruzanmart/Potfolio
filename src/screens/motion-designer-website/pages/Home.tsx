      ...
      <section className="relative bg-hero py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-hero-sub max-w-3xl mx-auto mb-8 leading-relaxed">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-stroke/20 border border-stroke rounded-2xl p-8 text-center">
              <div className="text-6xl mb-4">🎬</div>
              <h3 className="text-xl font-semibold text-text mb-2">Ready to Start?</h3>
              <p className="text-text-2">Let's discuss your next project</p>
            </div>
          </div>
        </div>
      </section>
