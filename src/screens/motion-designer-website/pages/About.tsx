...
import { User, Award, Zap, Eye, ArrowRight, ExternalLink, Home } from 'lucide-react';
...
const About: React.FC = () => {
  ...
  const stats = [
    ...
    { icon: Eye, label: 'Total Views', value: '10M+' }
  ];
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <section className="mx-auto max-w-4xl">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Hi, I'm Ruzanna Martirosyan</h1>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {["Logo Animation","Explainer Videos","UI Motion","Social Content","Lottie"].map(x => (
              <span key={x} className="inline-flex items-center rounded-full border px-3 py-1 text-sm text-gray-700">{x}</span>
            ))}
          </div>
        </section>
        ...
        <section className="mb-20 mt-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Tools & Skills</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            {skills.map((skill, index) => (
              <div key={index} className="text-center group">
                <div className="w-20 h-20 mx-auto mb-4 bg-white rounded-2xl shadow-lg flex items-center justify-center text-3xl group-hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                  {skill.icon}
                </div>
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Selected Work Highlights</h2>
            <p className="text-xl text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {highlights.map((highlight) => (
              ...
              >
                ...
                <div className="p-6">
                  <div className="text-sm text-[#ff6f61] font-medium mb-2">{highlight.category}</div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-[#ff6f61] transition-colors duration-200">
                    {highlight.title}
                  </h3>
          ...
          <div className="text-center mt-8">
            <Link
              to="/motion-designer-website/gallery"
              className="inline-flex items-center text-[#ff6f61] font-semibold hover:text-[#e55a4d] transition-colors duration-200"
            >
              View All Work
        ...
        {/* Step 4: CTA Section */}
        <section className="bg-gradient-to-r from-[#ff6f61] to-[#e55a4d] rounded-2xl p-8 lg:p-12 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="bg-white text-[#ff6f61] px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 inline-flex items-center justify-center"
            >
              Start a Project
              <ArrowRight className="h-5 w-5 ml-2" />
            </Link>
            <Link
              to="/motion-designer-website/gallery"
              className="border border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-[#ff6f61] transition-colors duration-200"
            >
              View Portfolio
            </Link>
          </div>
